...
class ColorObjDetectionNode(Node):
    def __init__(self):
        ...
        self.sub_rgb = self.create_subscription(Image, '/camera/color/image_raw', self.detected_goal_image_callback,10)
    ...
    def detected_goal_image_callback(self, msg):
        self.last_image = msg
        self.last_image_exists = True

    def camera_callback(self, points_msg):
        ...
        if self.last_image_exists:
            rgb_msg = self.last_image
            ...
            if self.searching:
                if self.first:
                    ...
                    if self.show_images:
                        ...
                        # plt.savefig('Area_Gray.png')
                        # plt.close()
                        
                        plt.imshow(self.past_image,'brg')
                        plt.savefig('Area_Color.png')
                        plt.close()
                    ...
                    if self.show_images:
                        ...
                        plt.savefig('Goal_Gray.png')
                        plt.close()
                        
                        plt.imshow(self.current_image,'brg')
                        plt.savefig('Goal_Color.png')
                        plt.close()
                    ...
                    try:
                        ...
                        if len(contours) > 0:
                            ...
                            if self.show_images:
                                ...
                                plt.imshow(image,'gray')
                                plt.savefig('gray_image_goal_box.png')
                                plt.close()
                ...
                #param_color_low2 = self.param_color_low.copy()
                #param_color_high2 = self.param_color_high.copy()
                #param_color_low2 -= 10
                #param_color_high2 += 10
                #color_mask2 = cv2.inRange(hsv_image, param_color_low2, param_color_high2)
                #Color Mask of goal parameters
                #plt.imshow(color_mask2,'gray')
                #plt.savefig('color_mask_goal2.png')
                #plt.close()
                
                #param_color_low3 = self.param_color_low.copy()
                #param_color_high3 = self.param_color_high.copy()
                #param_color_low3 -= 10

                #color_mask3 = cv2.inRange(hsv_image, param_color_low3, param_color_high3)
                #Color Mask of goal parameters
                #plt.imshow(color_mask3,'gray')
                #plt.savefig('color_mask_goal3.png')
                #plt.close()
                
                #param_color_low4 = self.param_color_low.copy()
                #param_color_high4 = self.param_color_high.copy()

                #param_color_high4 += 10
                #color_mask4 = cv2.inRange(hsv_image, param_color_low4, param_color_high4)
                #Color Mask of goal parameters
                #plt.imshow(color_mask4,'gray')
                #plt.savefig('color_mask_goal4.png')
                #plt.close()
                ...
                self.t2 = time.time()
                self.get_logger().info('image message published'+str(self.t2-self.t1))
                self.t1 = time.time()
